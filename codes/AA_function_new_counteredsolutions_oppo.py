...
import numpy as np
import pandas as pd
from Aindexdata_counteredsolutions_oppo import valuescollection,valuescollection_G1
import time 
...
for C in [i/10 for i in range(11)]:
    for D in [i/10 for i in range(11)]:
        for E in [i/10 for i in range(11-int(10*D))]:
            ...
            # results_df.to_csv(r'C:\Users\liu\Desktop\同步\opiniondynamic\modifiedHK\countered_solutiuons\results_oppo.csv')
results_df.to_csv(r'C:\Users\liu\Desktop\同步\opiniondynamic\modifiedHK\countered_solutiuons\results_countered_oppo.csv')
